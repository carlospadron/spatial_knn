...
# %%
# Add WKB geometry column for UPRN
uprn_wh = uprn_wh.withColumn("geom_wkb", expr("ST_AsBinary(geom)"))

# Add WKB geometry column for CodePoint
cp_wh = cp_wh.withColumn("geom_wkb", expr("ST_AsBinary(geom)"))

# %%
# Write output as ORC (with WKB geometry)
